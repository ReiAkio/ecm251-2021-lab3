...
public class ValidadorCPF {
    ...
    public static boolean validarCPF(String cpf){
        ...
        //validar se o tamanho do cpf está de acordo com o esperado
        if(cpf.length() != 11)
            return false;
        ...
        if (validarDigito(multiplicadoresSegundoDigito, cpf) && validarDigito(multiplicadoresSegundoDigito, cpf));
